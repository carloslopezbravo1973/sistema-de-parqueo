                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">REGISTRAR LOS DATOS CON MUCHO CUIDADO</h3>
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <label for="">Actividad de Empresa: <span style="color: red"><b>*</b></span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label for="">Depto. o Ciudad: <span style="color: red"><b>*</b></span></label>
